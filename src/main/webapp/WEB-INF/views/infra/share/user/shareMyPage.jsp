...
<body>
			...
			<div class="content">
		         	...
		         	<div class="col" style="margin-left: 90px; margin-top: 30px">
				    	<div class="col-md-6" id="fileBtn" style="margin-left: 90px; margin-top: 30px">
							<div class="filebox">
								...
								<input class="mb-5" type="file" id="chooseFile" name="chooseFile"  accept="image/*" onchange="loadFile(this)" multiple="multiple">
								<div class="row mt-5">
		        ...
		        <div class="row">
			        <div class="second col-3">주 share 장소</div>
			         <input type="text" id="share_place" name="share_place" class="col" placeholder="주 거래 장소를 입력해주세요." value="<c:out value="${item.share_place}"/>">
		        </div>
		        <div class="row">
			        <div class="third col-3">닉네임 변경</div>
			        <input type="text" id="nick_nm" name="nick_nm" class="col" placeholder="변경할 닉네임을 입력해주세요." value="<c:out value="${item.nick_nm}"/>">
		        </div>
		        <br>
		        <br>
	...
	<script type="text/javascript">
        ...
        document.querySelector("#chooseFile").addEventListener("change", (changeEvent) => {
        ...
        // 이미지 정보 넘기기
         validation = function() {
			 ...
			 var obj = document.getElementById("chooseFile").files;
