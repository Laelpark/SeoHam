...
public class CodeGroupDAO {
	...
	public int idCheck(CodeGroup dto) {return sqlSession.selectOne(namespace + ".idCheck", dto);}
	
	public CodeGroup selectOneId(CodeGroup dto) {
		CodeGroup result =  sqlSession.selectOne(namespace + ".selectOneId", dto);
		return result;
	}
	
	public CodeGroup selectOneLogin(CodeGroup dto ) {
		CodeGroup result =  sqlSession.selectOne(namespace + ".selectOneLogin", dto);
		return result;
	}
}
