...
//---------------------
	...
	public void setIfcgnamEng(String ifcgnamEng) {
		this.ifcgnamEng = ifcgnamEng;
	}
	public Integer getIfcguserNy() {
		return ifcguserNy;
	}
	public void setIfcguserNy(Integer ifcguserNy) {
		this.ifcguserNy = ifcguserNy;
	}
